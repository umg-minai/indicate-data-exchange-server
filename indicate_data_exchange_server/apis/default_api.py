...
@router.get(
    ...
    responses={
        ...
        400: {"model": ResultsGet400Response, "description": "Bad Request - Invalid data or missing required fields "},
        500: {"model": ResultsGet400Response, "description": "Internal Server Error - Unexpected error "},
    },
    tags=["default"],
...
async def results_get(
    ...
    return await BaseDefaultApi.subclasses[0]().results_get(aggregation_kind, period_start)
